...
class EditPostForm extends React.Component {
  ...
  submitForm = e => {
    ...
    delete postObject.fireRedirect;

    PostsAPI.updatePostData(postObject)
      .then(res => {
        if (res.data.errors) {
          this.grabCategories();
  ...
  getPostData = () => {
    ...
    PostsAPI.getPostDataForEdit(postId, userId)
      .then(res => {
        if (!res.data) {
          window.location = "/";
        }
        ...
        if (res.data) {
          this.setState({
            ...
            postCategory: res.data.categoryId,
            postPrice: res.data.price,
            postObo: res.data.obo,
                    ...
                    <div className="card">
                      ...
                      >
                        <div className="card-header" role="tab" id="headingOne">
                          <h5 className="mb-0">Optional Fields</h5>
                        </div>
                      </a>
                            ...
                            <Col size="md-4">
                              <div className="form-group">
                                ...
                                <input
                                  ...
                                  value={this.state.postStreetAddress}
                                  onChange={this.handleInputChange}
                                />
                              </div>
                            </Col>
              ...
              <ContentCard>
                <ContentCardBody>
                  ...
                  <div className="form-group">
                    <Row>
                      <Col size="md-6">
                        <label htmlFor="inputOBO" className="form-label">
                          Accept Best Offer
                        </label>
                      </Col>
                      <Col size="md-1">
